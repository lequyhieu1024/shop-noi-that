...
?>
    ...
    <div class="container">
        ...
        <div class="col-md-8 input-group mb-3">
            ...
            <input disabled type="text" class="form-control" value="<?=$kich_thuoc?>" required name="kich_thuoc_bien_the" placeholder="Dài x Rộng x Cao (đơn vị Cen-ti-met). VD: 20x30x50 cm" aria-describedby="basic-addon1">
        </div>
        <div class="col-md-8 input-group mb-3">

...
<a href="?url=form-add-brand"><button class="btn btn-primary">Thêm thương hiệu</button></a>
        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?url=form-update-brand&id=<?= $id_thuong_hieu ?>"><button class="btn btn-warning">Sửa</button></a>
                        <a href="index.php?url=delete-brand&id=<?= $id_thuong_hieu ?>"><button class="btn btn-danger">Xóa</button></a>
                    </td>
                </tr>

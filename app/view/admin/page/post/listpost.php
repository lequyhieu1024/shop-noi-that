        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?act=editpost&id=<?=$id_bai_viet?>"><button class="btn btn-warning">Sửa</button></a>
                        <a href="index.php?act=deletepost&id=<?=$id_bai_viet?>"><button class="btn btn-danger">Xóa</button></a>
                    </td>
                </tr>

<?php 
    ...
    function editsp($id_san_pham,$ten_san_pham,$anh_san_pham,$mo_ta,$gia_tien,$so_luong,$kich_thuoc,$so_luot_thich,
        $so_luot_xem,$id_danh_muc,$id_thuong_hieu,$show_san_pham)
        {
            if($anh_san_pham != ""){
                ...
                mo_ta='$mo_ta',gia_tien='$gia_tien',so_luong='$so_luong',kich_thuoc = '$kich_thuoc',so_luot_xem='$so_luot_xem',so_luot_thich='$so_luot_thich',

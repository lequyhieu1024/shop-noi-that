...
<form method="post" action="index.php?redirect=addtocart" class="product-details-area section-padding-1 pb-90">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6">
                            ...
                            <div class="product-details-peragraph">
                                <ul>
                                    <li style="list-style:none">
                                        <button class="text-center color-variant-button" style="border: 1px solid #F2EFEF; width: 90px;">
                            ...
                            <div class="product-details-action-wrap">
                                <div class="product-details-quality">
                                    <div class="cart-plus-minus">
                                        <input class="cart-plus-minus-box" type="text" name="so_luong" value="1">
                                    </div>
                                </div>
                                <div class="product-details-cart">
                                    <input type="hidden" value="<?=$row['id_san_pham']?>" name="id_san_pham">
                                    <input type="hidden" value="<?=$row['ten_san_pham']?>" name="ten_san_pham">
                                    <input type="hidden" value="<?=$row['gia_tien']?>" name="gia_tien">
                                    <button type="submit" name="addtocart" style="border:none;background-color:white"><a>Add to cart</a></button>
                                </div>
                    ...
                    <div class="product-details-col-28">
                        <div class="pro-details-sidebar-active slider-nav-style-3 owl-carousel">
                            <div class="single-pro-details-sidebar">
                                <a href="#"><img src="public/image/<?=$row['anh_thuong_hieu']?>" alt=""></a>
